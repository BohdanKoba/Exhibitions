...
public class Fields {
    ...
    public static final String ACCOUNT_COLUMN_ROLE_ID = "role_id";

    public static final String ROLE_COLUMN_ROLE_NAME = "role_name";
    ...
    public static final String EXHIBITION_COLUMN_CATEGORY_ID = "category_id";
    public static final String EXHIBITION_COLUMN_STATUS_ID = "status_id";

    public static final String STATUS_COLUMN_STATUS_NAME = "status_name";
