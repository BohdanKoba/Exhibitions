            ...
            <tr>
                ...
                <td style="border: none">
                    <c:if test="${not empty exhibition}">
                        <button style="width: 130px" type="submit" name="exhibitionId" value="${exhibition.id}"><fmt:message key="buyTickets"/></button>
                    </c:if>
                    <br><br>
                    <button style="width: 130px"><a class="linkButton" href="${contextPath}/view/index.jsp"><fmt:message key="cancel"/></a></button>
                </td>
            </tr>
        </table>
